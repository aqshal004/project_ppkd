...
class LoginPosyanduFirebase extends StatefulWidget {
  const LoginPosyanduFirebase({super.key});

  @override
  State<LoginPosyanduFirebase> createState() => _LoginPosyanduFirebaseState();
}

class _LoginPosyanduFirebaseState extends State<LoginPosyanduFirebase> {
                              ...
                              child: ElevatedButton(
                                ...
                                if (_formKey.currentState!.validate()) {
                                  try {
                                    ...
                                    final userData = await FirebaseService.getUserData(firebaseUser.uid!);
                                    ...
                                    await PreferencesHandler.saveRole(userData['role'] ?? 'user');
                                  ...
                                  prefs.setString("userUid", firebaseUser.uid!);
                                    // Routing berdasarkan role
                                    if (userData['role'] == 'admin') {
                                      Navigator.pushNamed(context, '/bottomnav');
                                    } else {
                                      Navigator.pushNamed(context, '/bottomuser');
                                    }
                                  } catch (e) {
                                    if (!mounted) return;
